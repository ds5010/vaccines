...
def comparison(FIPS_1='44003', FIPS_2='01125'):
    ...
    ax1.bar(x - width/2, FIPS_1_vax, width, color='#b8e186', label = '% Vaccinated in '+FIPS_1_name)
    ax1.bar(x + width/2, FIPS_2_vax, width, color='#f1b6da', label = '% Vaccinated in '+FIPS_2_name)
    ax2 = ax1.twinx()
    ax2.plot(x, FIPS_1_death, color='#4dac26', label = '# of Deaths in '+FIPS_1_name)
    ax2.plot(x, FIPS_2_death, color='#d01c8b', label = '# of Deaths in '+FIPS_2_name)
