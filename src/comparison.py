...
def comparison(FIPS_1='44003', FIPS_2='01125'):
    ...
    ax1.bar(x - width/2, FIPS_1_vax, width, color='darkcyan', label = '% Vaxxed in '+FIPS_1_name)
    ax1.bar(x + width/2, FIPS_2_vax, width, color='darkslategray', label = '% Vaxxed in '+FIPS_2_name)
    ax2 = ax1.twinx()
    ax2.plot(x, FIPS_1_death, color='indianred', label = '# of Deaths in '+FIPS_1_name)
